	...
	foreach ($datos as $rows) {
		...
		$tabla .= '</p>
			        ...
			        <div class="media-content">
			            <div class="content">
			              <table>
			                <tr><td><strong>' . $contador . ' - ' . $rows['producto_nombre'] . '</strong></td></tr>
			                <tr><td><strong>CODIGO:</strong> ' . $rows['producto_codigo'] . '</strong></td></tr> 
							<tr><td><strong>PRECIO:</strong> $' . $rows['producto_precio'] . '</strong></td></tr>
							<tr><td><strong>STOCK:</strong> ' . $rows['producto_stock'] . '</strong></td></tr> 
							<tr><td><strong>CATEGORIA:</strong> ' . $rows['categoria_nombre'] . '</strong></td></tr>
			              </table>
			            </div>
