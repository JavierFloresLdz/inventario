			        ...
			        <div class="media-content">
			            <div class="content">
                            <div class="container">
                                <div class="card">
			              <table>
			                <tr><td><strong><h1>' . $contador . ' - ' . $rows['producto_nombre'] . '</h1></strong></td></tr>
			                <tr><td><strong>CODIGO:</strong> ' . $rows['producto_codigo'] . '</strong></td><td><strong>PRECIO:</strong> $' . $rows['producto_precio'] . '</strong></td></tr>
							<tr><td><strong>STOCK:</strong> ' . $rows['producto_stock'] . '</strong></td><td><strong>CATEGORIA:</strong> ' . $rows['categoria_nombre'] . '</strong></td></tr>
			              </table>
			            </div>
			            </div>
			        </div>
